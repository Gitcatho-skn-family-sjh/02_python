...
from skn.my_math import get_circle_areaz
...
# dir() 내장 함수 : 현재 모듈(_02_module.py)의 상ㅇ 가능한 속성/함수 등을 나열
print("dir(): ", dir())
...
print("math.__name_: ", math.__name__)
...
# print('my_math.get_circle_area(10)', my_math.get_circle_areaz(10))
#
...
# print("pi: ", pi)
# print("x: ", x)
# print("get_circle_area(10): ",get_circle_areaz(10))
#
...
import 모듈명, import 모듈명 as 별칭 방식 이 더 권장된다!
